  ...
  <div class="row">
    <b-col cols="12">
      ...
      <b-form v-if="!loading">
        ...
        >
          <b-form-input id="input-roomcode" v-model="form.roomcode" type="text" placeholder="Name"></b-form-input>
        </b-form-group>
        <b-form-group
        ...
        >
          <b-form-input id="input-zonecode" v-model="form.zonecode" type="text" placeholder="Name"></b-form-input>
        </b-form-group>
        <b-form-group
        ...
        <b-button type="button" variant="secondary">Back</b-button>
      </b-form>
    </b-col>
  </div>
</template>
