                            ...
                            <div class="col-lg-6 col-md-12">
                                <form method="POST" action="/layers/detail/{{$layer->id}}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="layer_name" id="layer_name" value="{{$layer->layer_name}}" />
                                    </div>
                                    <div class="form-group">
                                        <label for="url">Địa chỉ Layer</label>
                                        <textarea class="form-control" name="url" id="url">{{$layer->url}}</textarea>
                                    </div>
                                    <div class="form-check-inline">
                                        <label for="user_hidden" class="form-check-label">Ẩn phía User </label>
                                        <input type="checkbox" class="form-check-input" name="user_hidden" id="user_hidden" {{$layer->user_hidden?'checked':''}} />
                                    </div>
                                    <div class="form-group">
